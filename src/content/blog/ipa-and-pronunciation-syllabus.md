...
![image.png](/images/blog/f447708808157a32f20dc3efe391bf9a.png)
...
- **Là gì?**
	...
	- `Mono` = một.
	- Không chủ động trượt sang một vowel khác.
- **Hình dung**
	- `/æ/`
...
- **Ví dụ**
	- `sit /sɪt/`
		- /ɪ/ được phát nhanh và tương đối lỏng.
- **Điểm dễ hiểu sai**
...
- **Lỗi thường gặp**
	- Người Việt dễ đọc /ɪ/ thành âm `i` quá rõ.
	- `sit` dễ bị đọc gần giống "xít".
...
- **Là gì?**
	...
	- Trong IPA truyền thống, thường có ký hiệu `/ː/`.
- **Gồm**
	- /iː/ → see
	- /ɑː/ → car
	- /ɔː/ → law
...
> **Nhớ:** `/ː/` = chú ý độ dài **và** chất lượng âm.
...
- **Ví dụ**
	- `my /maɪ/`
	- Miệng bắt đầu ở vùng âm đầu và trượt sang vùng âm cuối.
- **So sánh**
	- Monophthong → `●────●`
	- Diphthong → `●────→●`
- **Lỗi thường gặp**
	- Đọc diphthong thành một âm phẳng.
	- Ví dụ /eɪ/ chỉ đọc thành `e`.
...
- **Ví dụ**
	- `/p/` trong `pipeline`.
	- Hai môi đóng → giữ khí → mở môi.
- **Cách nhận biết**
	- Không thể giữ một luồng âm liên tục.
	- `/s/` → sssssss ✅
	- `/p/` → ppppppp ❌
		- Thực chất là nhiều cú bật `/p/`.
...
- **Ví dụ**
	- `about /əˈbaʊt/`
	- Dấu `/ˈ/` đứng trước syllable được nhấn.
	- a-**BOUT**
...
- **Ví dụ**
	...
	- `to` mang ý đối lập nên được nhấn.
...
- **Ví dụ**
	- `I bought the PHONE.`
		- Phone, không phải laptop.
	- `I BOUGHT the phone.`
		- Tôi mua, không phải mượn.
	- `I bought the RED phone.`
		- Red, không phải màu khác.
...
- **Ví dụ**
	- `ten boys`
	- /n/ có thể tiến gần /m/ khi nói nhanh.
...
- **Ví dụ**
	- `next day`
	- /t/ có thể không được phát rõ trong một số cách nói.
- **Tại sao xảy ra?**
